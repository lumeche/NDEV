...
public class TTSHTTPClient {
	...
	private String DEVICE_ID = Config.DEVICE_ID;
	private String VOICE = Config.VOICE;
	private String LANGUAGE = Config.LANGUAGE;
	private String CODEC = Config.CODEC;
	private String TEXT = Config.TEXT;
	 ...
	 *********************************************************************************************************
	 */
	private static short PORT = Config.PORT;
	private static String HOSTNAME = Config.HOSTNAME;
	private static String TTS = Config.TTS_SERVER_PATH;
